...
namespace WebShop.Models
{
    public partial class dbMarketsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=.\\SQLEXPRESS;Initial Catalog=dbMarkets;Integrated Security=True");
            }
        }
        ...
        public DbSet<WebShop.ModelViews.RegisterViewModel> RegisterViewModel { get; set; }
